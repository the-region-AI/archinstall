...
"""
    ...
    with open("CYBERWIN_STATION/cyberwin_finetune_engine.py", "w") as f:
        f.write(script_content)
    
    print("\n[OK] Motore di Fine-Tuning creato: CYBERWIN_STATION/cyberwin_finetune_engine.py")
    print("[!] Nota: Per eseguire questo script è necessaria una GPU NVIDIA e l'installazione di Unsloth.")

if __name__ == "__main__":
    crea_finetune_script()
